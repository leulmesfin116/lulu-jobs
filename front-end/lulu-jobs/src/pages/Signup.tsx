    ...
    <div className="relative min-h-screen w-full flex items-center justify-center bg-gray-50 dark:bg-[#050505] px-6 overflow-hidden transition-colors duration-300">
      ...
      <div className="w-full max-w-md bg-white dark:bg-[#0a0a0a] p-8 rounded-3xl shadow-xl border border-gray-100 dark:border-gray-800 animate-fade-up relative z-10">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-extrabold tracking-tight mb-2 dark:text-white">Create Account</h1>
          <p className="text-gray-500 italic dark:text-gray-400">Join <span className="text-green-500 font-bold">Lulu</span> and build your future</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="flex items-start items-center gap-2 px-1">
             ...
             <span className="text-xs text-gray-500 dark:text-gray-400">I agree to the <span className="text-green-600 dark:text-green-400 font-semibold cursor-pointer">Terms of Service</span> and <span className="text-green-600 dark:text-green-400 font-semibold cursor-pointer">Privacy Policy</span></span>
          </div>
        ...
        <div className="relative my-8">
           ...
           <div className="relative flex justify-center text-xs uppercase"><span className="bg-white dark:bg-gray-800 px-2 text-gray-400 dark:text-gray-500 font-medium">Or continue with</span></div>
        </div>
        ...
        <p className="text-center mt-8 text-gray-500 dark:text-gray-400 text-sm">
          Already have an account? <Link to="/Auth" className="text-green-600 dark:text-green-400 font-bold hover:underline">Log in</Link>
        </p>
      </div>
    </div>
  );
