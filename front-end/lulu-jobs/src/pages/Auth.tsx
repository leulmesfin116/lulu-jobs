    ...
    <div className="relative min-h-screen w-full flex items-center justify-center bg-gray-50 dark:bg-[#050505] px-6 transition-colors duration-300">
      ...
      <div className="w-full max-w-md bg-white dark:bg-[#0a0a0a] p-8 rounded-3xl shadow-xl border border-gray-100 dark:border-gray-800 animate-fade-up">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-extrabold tracking-tight mb-2 dark:text-white">Welcome Back</h1>
          <p className="text-gray-500 italic dark:text-gray-400">Login to your <span className="text-green-500 font-bold">Lulu</span> account</p>
        </div>
        ...
        <p className="text-center mt-8 text-gray-500 dark:text-gray-400 text-sm">
          Don't have an account? <Link to="/Signup" className="text-green-600 dark:text-green-400 font-bold hover:underline">Start for free</Link>
        </p>
      </div>
    </div>
  );
